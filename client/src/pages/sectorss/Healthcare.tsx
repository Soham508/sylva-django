                    ...
                    <div className="flex flex-col space-y-8">
                        <div>
                            ...
                            <p className="text-lg text-slate-600 leading-relaxed font-light mt-4">
                                Dominated by generics, which account for 20% of global
                            ...
                            <p className="text-lg text-slate-600 leading-relaxed font-light mt-4">
                                ...
                                like the U.S. remain significant. Despite these, ongoing
                                government initiatives position India for sustained long-term growth.
                            </p>
                        </div>
                        ...
                        <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm">
                            ...
                            <div className="space-y-4">
                                <a
                                    href="/reports/Equity_Report_Healthcare.pdf"
                                ...
                                <a
                                    href="/reports/Sector_Report_Healthcare.pdf"
                    ...
                    <div className="relative">
                        <div className="sticky top-24">
                            <div className="rounded-2xl overflow-hidden shadow-2xl bg-white p-2 border border-slate-100">
                                <img
                                    src={pharmaGraph}
                                    alt="Healthcare Sector Analysis Graph"
